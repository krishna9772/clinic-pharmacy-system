  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <?php echo form_open('reports/yearlyVisits',array("class"=>"form-inline","id"=>"reportform","role"=>"form"));?>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Visiting - Report</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Visiting  - Report Data</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
