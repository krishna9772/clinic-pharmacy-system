                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Pharmacy</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createPharmacy" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updatePharmacy" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewPharmacy" class="minimal"></td>
