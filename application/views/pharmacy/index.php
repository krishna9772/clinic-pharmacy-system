          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th>Expire Date</th>
                <th>Price</th>
                <?php if(in_array('updatePharmacy', $user_permission) || in_array('deletePharmacy', $user_permission)): ?>
                  <th>Action</th>
                <?php endif; ?>
              </tr>
              </thead>
...
<?php if(in_array('deletePharmacy', $user_permission)): ?>
<!-- remove brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('pharmacy/delete') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'pharmacy/fetchProductData',
    'order': []
  });
...
function removeFunc(id)
{
  ...
  $("#manageTable").on('click', "a" ,function(e){
