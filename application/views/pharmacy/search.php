      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php
            ...
            echo form_input('q','','class="form-control" id="drugQ" required autocomplete="off"'); // 
            echo form_close();
            echo "<p></p>";
          ?>
    ...
    $(document).ready(function(){
      ...
      $('#drugQ').keyup(function(e){
        if(e.which!=27){//if not esc
            //$.get("<?php echo site_url('pharmacy/search').'/';?>"+$('#drugQ').val(),'',
            $.post("<?php echo site_url('pharmacy/search');?>",$('#formDrugQ').serialize(),
                function(data){
