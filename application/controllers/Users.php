...
class Users extends Admin_Controller 
{
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('username', 'Username', 'trim|required|min_length[5]|max_length[12]|is_unique[ra_user.username]');
		$this->form_validation->set_rules('email', 'Email', 'trim|required|is_unique[ra_user.email]');
